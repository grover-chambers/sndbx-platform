          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Add your company details to get better matches</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-slate-900">Submit your needs</p>
                <p className="text-xs text-slate-500">Get matched with the right specialist firms</p>
              </div>
            </div>
          </div>
        </div>
