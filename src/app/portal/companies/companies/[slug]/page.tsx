      ...
      <div className="min-h-screen bg-slate-50">
        <div className="p-6">
          <div className="bg-white rounded-xl border border-slate-200 p-12 text-center">
            ...
            <Link href="/companies" className="text-teal-600 hover:underline">
              ← Back to Companies
            </Link>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-white border-b border-slate-200">
        <div className="px-4 py-4 md:px-8">
          <Link href="/companies" className="inline-flex items-center gap-2 text-slate-500 hover:text-teal-600 transition">
